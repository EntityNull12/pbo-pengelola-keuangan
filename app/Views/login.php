...
<form class="max-w-2xl mx-auto" method="post" action="<?= base_url('login/authenticate') ?>">
  ...
  <div class="mb-5">
    ...
    <input type="text" id="username" name="username" class="bg-transparent border border-yellow-200 text-yellow-200 text-lg rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 " placeholder="Nama Anda" required />
  </div>
  <div class="mb-5">
  ...
  <button type="submit" class="text-yellow-200 bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Masuk</button>
</form>
