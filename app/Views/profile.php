...
<body class="bg-gray-800 text-white" x-data="{ open: false, modalOpen: false }">
    <div class="container mx-auto py-12">
        <div class="bg-gray-900 rounded-lg shadow-lg p-6 text-center relative">
            ...
            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-lg z-10" x-transition>
                ...
                <a href="/change-profile-photo" class="block px-4 py-2 text-sm hover:bg-indigo-600">Change Profile Photo</a>
            </div>
            <img src="https://source.unsplash.com/100x100/?portrait" alt="User Photo" class="w-32 h-32 rounded-full border-4 border-indigo-600 mx-auto mb-4">
            <h1 class="text-4xl font-bold mb-2"><?php echo esc($nama); ?></h1> <!-- Menampilkan nama pengguna -->
